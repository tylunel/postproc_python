...
color_map = 'coolwarm_r'   # coolwarm, plasma, YlGnBu_r, ... (add _r to reverse)
                    # YlOrBr for ZS
                    # YlGn for LAI_ISBA
                    # coolwarm_r for SWI3_ISBA

var_name = 'SWI3_ISBA'   #LAI_ISBA, ZO_ISBA, PATCHP7, ALBNIR_S, MSLP, TG1_ISBA, RAINF_ISBA, CLDFR, TSWI_T_ISBA
vmin = -0.2
vmax = 1.2
colorbar_label = 'SWI'  # Leaf Area Index [m$^{2}$ m$^{-2}$], Altitude [m], SWI
...
plot_title = gv.longnamedict[model]  # Relief, LAI, SWI
