...
figsize = (12,6)
save_plot = True
save_folder = f'/home/lunelt/postproc_python/article2/fig/cross_sections/{budget_type}_{var_name_bu}/{vector_visu}/'
...
for site_inter in sites_to_project:
    ...
    # add to the dict
    # abscisse_sites[abscisse_inter] = gv.whole[site_inter]['longname']
