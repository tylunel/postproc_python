...
#arr_obs_var=(ta_2 hus_2 soil_temp_2 soil_temp_1 shf_1 lhf_1)
arr_obs_var=(TEMP_2m RHO_2m ST10 H_2m LE_2m)
arr_sim_var=(T2M_ISBA Q2M_ISBA TG3_ISBA H_ISBA LE_ISBA)
#arr_sim_var=()
